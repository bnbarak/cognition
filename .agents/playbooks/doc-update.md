...
8. **DO NOT** hand-edit auto-generated files. Files with a `_generated` field at the top are produced by scripts and will be overwritten on the next regeneration. To update them, modify the source (annotations) and re-run the generation script.

---

## Auto-Generated Files

The following files are **auto-generated** and must NOT be edited by hand. They contain a `_generated` metadata field marking them as such.
